...
class Cluster(ABC):
    ...
    def add(self, dp):
        """
        Creates a new cluster where the data point has been added.
    ...
    def merge(self, other):
        ...
        Returns:
        Cluster: A new cluster that is the merger of the 2 clusters.
        """
    ...
    def contains(self, dp):
        """
        Precondition: The data point has been assigned to a cluster.
    ...
    def mahalanobis_distance(self, dp):
        ...
        Returns:
        float: The mahalanobis distance between the centroid of this cluster and a data point.
        """
    pass
    ...
    def is_data_point_sufficiently_close(self, dp):
        ...
        Returns:
        bool: True iff the mahalanobis distance is less than 3 times the std on at least one axis.
        """
    pass
...
def load_data(file_path, chunk_size, create_data_point_func):
    ...
    Returns:
    List[List[DataPoint]]: Returns the data points as a list of chunks.
    """
    lines = []
...
def hierarchical_clustering(data, k):
    ...
    Returns:
    List[Cluster]: The k clusters. If the data contains fewer than k datapoints it returns the orignal list.
    """
...
def find_two_closest(data):
    ...
    Returns:
    Tuple[int, int]: Returns the indices of the two clusters.
    """
    min_one_i = None
    min_other_j = None
